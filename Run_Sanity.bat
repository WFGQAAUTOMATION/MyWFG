ECHO
call pybot --outputdir O:\BusinessSupport\Jenkins_Reports\Gherkin_Login_Results --variablefile C:\Jenkins_Files\Variable_Files\Model_Variables.py "C:\Jenkins_Files\Test_Cases\01-Login\*.robot"
