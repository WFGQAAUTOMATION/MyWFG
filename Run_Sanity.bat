...
call pybot --outputdir Dashboard_Results --variablefile C:\Jenkins_Files\Variable_Files\Model_Variables.py "C:\Jenkins_Files\MyWFG_Model\Test_Cases\03-Dashboard\*.robot"
