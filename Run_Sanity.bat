...
::call pybot --outputdir Lifeline_Results.html --variablefile C:\Jenkins_Files\Variable_Files\Model_Variables.py "C:\Jenkins_Files\Test_Cases\09-LifeLine_Footer\LifeLine_Archive_Open_Close.robot"
