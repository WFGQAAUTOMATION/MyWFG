ECHO
call pybot --proxy  http://tcoffey:Scout654@cr-proxy.us.aegon.com:9090 --outputdir Logs_Login --variablefile C:\Jenkins_Files\Variable_Files\Model_Variables.py "C:\Jenkins_Files\Test_Cases\01-Login\*.robot"
...
::call pybot --outputdir Logs_Lifeline --variablefile C:\Jenkins_Files\Variable_Files\Model_Variables.py "C:\Jenkins_Files\Test_Cases\09-LifeLine_Footer\*.robot"
