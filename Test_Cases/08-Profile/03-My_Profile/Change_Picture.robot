...
#    xpath=//span[@class="ui-button-text"][contains(text(),'Ok')]
#    xpath=//div[@aria-labelledby="ui-id-1"]/div[@class='ui-dialog-buttonpane ui-widget-content ui-helper-clearfix']/div[@class="ui-dialog-buttonset"]/button[@type="button"]/span[contains(text(),'Ok')]
#
